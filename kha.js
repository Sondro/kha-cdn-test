...
var Main = function() {
	var _gthis = this;
	kha_Assets.loadImageFromPath("https://d2u64t73ywlwt4.cloudfront.net/weekly-client/1511869755.geres.png",false,function(image) {
		_gthis.image = image;
...
Main.prototype = {
	...
	,render: function(fb) {
		...
		g2.drawScaledImage(this.image,0,0,kha_System.windowWidth(),kha_System.windowHeight());
		g2.end();
	}
	,__class__: Main
};
